...
var FORM_ID = process.env.FORM_ID || '585b9e888772c41836b37dd0';

var BACKEND_SERVICE_GUID = process.env.BACKEND_SERVICE_GUID || 'hlcvqjpcf6raquhojqbbqnlp';
...
function getSubmitFormData() {
  logger.error('submissions: getSubmitFormData');
  return new Promise(function(resolve, reject) {
    if (typeof BACKEND_SERVICE_GUID === 'undefined') {
      reject('Enviroment variable BACKEND_SERVICE_GUID not defined in Cloud App!');
      return;
